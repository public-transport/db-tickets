...
import parseLegs from './parse.js'
  ...
  .then(json => {
    ...
    return {
      ...
      journey: { // follows FPTF Journey, https://github.com/public-transport/friendly-public-transport-format/blob/master/spec/readme.md#journey
        ...
        // todo: get price from httext
        // base64 decode and then something like regex match 'Gesamtpreis: xx,xx EUR'
        // price: {
        //   amount: 19.95, // number, required
        //   currency: 'EUR' // ISO 4217 code, required
        // }
      }
      // todo: add another FPTF journey, if the ticket has a return journey
    }
  })
  .catch(err => {
    throw new Error(err)
